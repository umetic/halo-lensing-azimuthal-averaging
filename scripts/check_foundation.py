...
outputs/foundation_validation/, which belongs in the repository's ignore rules.
"""
...
def main() -> int:
    ...
    parser.add_argument('--output-dir', default='outputs/foundation_validation',
    ...
    try:
        ...
        origins = {}
        for name in ('cosmology', 'nfw', 'projection'):
    ...
    print('Running the cosmology, NFW, and projection tests...')
    sys.stdout.flush()
