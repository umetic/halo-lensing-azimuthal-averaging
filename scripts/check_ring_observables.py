#!/usr/bin/env python3
"""Run deterministic-core tests through ring fields and observables.

From the repository root, after activating the project environment:
    python scripts/check_ring_observables.py

No packages are installed and no Git operations are performed. Reports go to
outputs/ring_observables_validation/, which belongs in the repository's ignore
rules.
"""
...
def main() -> int:
    ...
    parser.add_argument('--output-dir', default='outputs/ring_observables_validation',
    ...
    metadata = {
        'validation_layer': 'ring-observables-v0.1.0',
    ...
    print('Running deterministic-core tests through ring fields and observables...')
    sys.stdout.flush()
